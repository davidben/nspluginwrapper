...
$(npwrapper_LIBRARY): $(npwrapper_OBJECTS)
	$(CC) $(LDFLAGS) -o $@ $(DSO_LDFLAGS) $(npwrapper_OBJECTS) $(npwrapper_LDFLAGS)
...
test-rpc-%-client: test-rpc-%-client.o $(test_rpc_client_OBJECTS)
	$(CC) $(LDFLAGS) -o $@ $< $(test_rpc_client_OBJECTS) $(test_rpc_LDFLAGS)
...
test-rpc-%-server: test-rpc-%-server.o $(test_rpc_server_OBJECTS)
	$(CC) $(LDFLAGS) -o $@ $< $(test_rpc_server_OBJECTS) $(test_rpc_LDFLAGS)
